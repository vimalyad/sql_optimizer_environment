...
"""
FastAPI application for the Sql Optimizer Environment.
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m sql_optimizer.server.app
    ...
    multiple workers:
        uvicorn sql_optimizer.server.app:app --workers 4
    """
    import uvicorn
